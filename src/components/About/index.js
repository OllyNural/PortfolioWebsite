          ...
          <div className="page-container">
            <div className="about-container">
              ...
              <div className="about-introduction">
                ...
                <p>In my spare time I volunteer at a local Church coffee shop, and enjoy playing Saxophone and Piano. And when I'm not doing any of the above, i'm working on my own side <a href="https://github.com/OllyNural" target="github"><span className="title-name">projects</span></a> (including this website), or playing atmospheric and envoloping video games.</p>
              </div>
            </div>
          </div>
        </Layout>

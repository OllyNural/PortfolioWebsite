    ...
    return (
        <Layout>
          <div className="v1-page-container">
            <div className="v1-about-container">
              <Title title="About Me" />
              <div className="v1-about-introduction">
                <p>After achieving a First Class Honours in Computer Science, with a year in Industry at <a href="http://www.paconsulting.com/" target="_blank" rel="noopener noreferrer"><span className="v1-title-name">PA Consulting</span></a>, I am starting a graduate role as a Product Developer at <a href="https://and.digital/" target="_blank" rel="noopener noreferrer"><span className="v1-title-name">AND Digital</span></a>. </p>
